-- =============================================================================
-- Supabase: таблица contacts + updated_at + RLS + Realtime
-- Выполните в SQL Editor (Dashboard → SQL → New query) один раз на проект.
-- =============================================================================
...
-- RLS: полный доступ для anon и authenticated (общая таблица без Supabase Auth в приложении).
...
-- Realtime: postgres_changes требует таблицу в publication supabase_realtime
do $pub$
begin
